...
|[Inline http-basic](#inline-http-basic)|yes|
|[HTTP Bearer](#http-bearer)|yes|
|[Custom header](#custom-token-authentication)|yes
...
```shell
php composer.phar config --local --editor [--auth]
```
